...
| Property | Value |
|----------|-------|
| **Contest** | [ai-santas-list](https://github.com/CodeHawks-Contests/ai-santas-list) |
...
[View Full Report](./SantaToken.sol_audit.md)
...
[View Full Report](./SantasList.sol_audit.md)
